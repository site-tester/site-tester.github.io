                ...
                $.each(errors, function(bag, errorMessages) {
                    $.each(errorMessages, function(inputName, messages) {
                        ...
                        container.find('input, textarea, select').each(function() {
                            ...
                            if (!container.hasClass('repeatable-group') && !container
                                .hasClass('no-error-display')) {
                        ...
                        $.each(messages, function(key, msg) {
                            ...
                            var row = $('<div class="invalid-feedback d-block">' + msg +
                                '</div>');
                            ...
                            @if ($crud->tabsEnabled())
                                var tab_id = $(container).closest('[role="tabpanel"]').attr(
                                    'id');
                                $("#form_tabs [aria-controls=" + tab_id + "]").addClass(
                                    'text-danger');
                            @endif
                        });
                    });
