            ...
            <div class="my-5 ">
                ...
                <form class="row" action="{{-- {{ route('customer.profile.update', Auth::user()->id) }} --}}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="col-12 col-lg-3 border-end border-top pe-0">
                        <ul id="myProfileTab" class="nav nav-pills flex-column " role="tablist"  aria-orientation="vertical">
                            <li class="nav-item ">
                                <h5><a class="nav-link w-100 float-end text-end active rounded-start" href="#profile-details-tab" role="tab"
                                        data-bs-toggle="tab" >Profile</a></h5>
                            </li>
                            <li class="nav-item ">
                                <h5><a class="nav-link w-100 float-end text-end rounded-start" href="#profile-org-tab" role="tab"
                                        data-bs-toggle="tab" >Organization</a></h5>
                            </li>
                            <li class="nav-item ">
                                <h5><a class="nav-link w-100 float-end text-end rounded-start" href="#profile-security-tab" role="tab"
                                        data-bs-toggle="tab" >Security</a></h5>
                            </li>
                        </ul>
                    </div>
                    <div class="col-12 col-lg-9 ps-0 tab-content border-top">
                            ...
                            <div class="">
                                ...
                                <div class="border-0 mb-4 mb-xl-0 p-3 p-md-4">
                                    <div class="text-center">
                                        ...
                                        <div class="small font-italic text-muted mb-4">JPG,JPEG or PNG no larger than 2 MB
                                        </div>
                        ...
                        <div id="profile-security-tab" class="tab-pane fade mb-4 p-3 p-md-4">
                            <div  class="">
                                <!-- Old Password -->
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="ProfileOldPassword" name="profileOldPassword" type="password">
                                ...
                                <!-- New Password -->
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="ProfilePassword" name="profilePassword" type="password">
